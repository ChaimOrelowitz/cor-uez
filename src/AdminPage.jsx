    ...
    <header className="admin-topbar">
      ...
      <details className="admin-mobile-menu">
        ...
        <div className="admin-mobile-menu-popover">
          ...
          <a href="/admin/home-stats">Home stats</a>
